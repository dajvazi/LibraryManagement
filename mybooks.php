          ...
          <div class="col-12 ">
            ...
            <div class="d-flex py-3">
              ...
              <div class="col-md-6 text-end">
                <button class="btn btn-add btn-lg fw-semibold fs-5 mt-3 mx-4"
                ...
                <div class="col-md-6">
                  <div class="input-group">
                    ...
                    <input type="search" class="form-control border-start-0" id="mbSearch"
                      placeholder="Search books, genre, authors..." aria-label="Search">
                  </div>
                </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <form class="modal-content shadow-sm" method="POST" action="functions/handleBooks.php">
      <div class="modal-header">
        <h5 class="modal-title fw-semibold" id="addBookModalLabel">
      ...
      <div class="modal-body">
        ...
        <div class="mt-3">
          ...
          <select name="genre" id="add_genre" class="form-select" required>
            <option value="" selected disabled>Select genre</option>
            <option value="Fantasy">Fantasy</option>
            <option value="Thriller">Thriller</option>
            <option value="Horror">Horror</option>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="addBookBtn" class="btn btn-success  ">
